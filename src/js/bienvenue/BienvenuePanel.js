...
var BienvenuePanel = createReactClass({
  ...
  UNSAFE_componentWillMount: function () {
    this.controller = require('./controller-BienvenuePanel').default(this.props.controller, this)
        ...
        <Jumbotron>
          ...
          <Media>
            ...
            <Media.Body>
              ...
              <p>Le Syst&egrave;me Expert YRexpert est libre et fonctionne sous Mumps <a href='http://www.fisglobal.com/products-technologyplatforms-gtm' target='_blank' rel='noopener noreferrer'>GT.M</a> et GNU/Linux. <a href='https://www.yrelay.fr/' target='_blank' rel='noopener noreferrer'>Yrelay</a> utilise de nombreuses contributions communautaires libres&nbsp;notamment l'application <a href='http://www.mgateway.com/' target='_blank' rel='noopener noreferrer'>EWD 3</a>.</p>
