    ...
    return (
      <div>
        ...
        <Navbar inverse collapseOnSelect>
          <Navbar.Header>
            <Navbar.Brand>
              <a href='https://www.yrelay.fr/' target='_blank' rel='noopener noreferrer'>{this.title}</a>
            </Navbar.Brand>
            <Navbar.Toggle />
          </Navbar.Header>
          <Navbar.Collapse>
            <Nav bsStyle='tabs' activeKey='1' handleSelect={this.props.controller.navOptionSelected}>
